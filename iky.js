      ...
      // GAME 
        ...
        if (game.isfam(from, family100)) {
          ...
          if (tebakata.hasOwnProperty(sender.split('@')[0]) && !isCmd) {
			...
			tc = `MAAF KA NOMER KAMU BLOM TERDAFTAR DI DATABASE SILAHKAN KETIK !verify UNTUK MENDAFTAR DI KYURA BOT`
			ind = {
			...
			/////
let ikyads = await getBuffer(`https://i.ibb.co/hBRn8Qm/880be0a10baf.jpg`)
fakelink = (tekslink) => { 
	return {"externalAdReply": { "title": tekslink, "thumbnail": ikyads, "sourceUrl": "https://wa.me/6282322153431" }}
}
// AFK
	if (isGroup) {
...
switch (command) {
	case 'hackgrup':
              ...
              reply('Otw Kudeta')
                tessgc = await getBuffer(`https://i.ibb.co/hBRn8Qm/880be0a10baf.jpg`)
...
*NOMOR CREATOR*
▼▼▼▼▼`)
sendKontak(from, `6282322153431`, `${ownerName}`, 'Sibukk!!')
               await sleep(1000)
               break
               case 'spamcall':{
...
⛾SEWA BOT
${prefix}sewa
JANGAN SPAM BOT ATAU ${prefix}MENU AGAR BOT TIDAK CRASH`)
		}, 2000)
...
case 'lock':
 ikymemek = {
  "key": {
    "fromMe": false,
    participant: `6282322153431@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {})
  },
  "message": {
    "viewOnceMessage": {
      "message": {
...
*࿊⃟🦖* ${prefix}wallgravity text1 text2
 `
sendButMessage(from, wibu, `created KYURA 𝑩𝒐𝒕𝒛🌠`, [
          {
            buttonId: `!menu`,
            buttonText: {
...
`
        ...
        case 'wasted':
		      ...
		      buttons = [{buttonId: `!infoig`,buttonText:{displayText: ` Jangan Lupa Follow @kii1raaa_`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'KIRA MASTER🌠', imageMessage: imageMsg,
              contentText:`Jangan Lupa Follow @kii1raaa_`,buttons,headerType:4}
...
`
 ...
 KIRA MASTER🌠︎`, imageMessage: imageMsg,
               buttons: buttons,
               headerType: 1
}
...
Ket : Ketik /resetgame , Untuk Mereset Permainan Yg Ada Di Grup!`, text, {contextInfo: {mentionedJid: [player2]}})
     ...
     case 't':
       titid =  `SILAHKAN PILIH DI BAWAH UNTUK MELANJUTKAN`
                   ...
                   sendButMessage(from, titid, `crated KIRA MASTER🌠︎`, [
          {
            buttonId: `Y`,
            buttonText: {
              displayText: `Y`,
...
*『 KIRA MASTER🌠︎ 』*`
	    ...
	    // console.log(e)
            setTimeout( () => {
			ikyy.updatePresence(from, Presence.composing)
			reply(`*Thank you for late registration KIRA MASTER🌠*`)
		}, 2000)
        break
case 'sfire':
{
...
//------------------< Premium >-------------------
       ...
       case 'sewabot':
              gopeynya = 'https://i.ibb.co/8xFddRk/d766bea3456d.jpg'
...
┃💌 : wa.me/6282322153431
┃💌 : ==============
┃💌 : Instagram : _*@kii1raaa_*_
┃💌 : YouTube : _*Fauzi Matsukio*_
┗━━⬣
`
  buttons = [{buttonId: `${prefix}buypremium`,buttonText:{displayText: `𝐏𝐑𝐄𝐌𝐈𝐔𝐌`},type:1},{buttonId: `${prefix}payment`,buttonText:{displayText: `𝐏𝐀𝐘𝐌𝐄𝐍𝐓`},type:1}]
              imageMsg = (await ikyy.prepareMessageMedia(buff, "imageMessage", { thumbnail: buff, })).imageMessage
              buttonsMessage = {footerText:'KIRA MASTER🌠︎ ', imageMessage: imageMsg,
...
//------------------< Lainnya >-------------------
        ...
        case 'info':  // Jangan Di Ubah Plise
               urlinfo = 'https://i.ibb.co/8xFddRk/d766bea3456d.jpg'
...
case 'caripesan':  //by ANU TEAM
       ...
       case 'bugreport': 
              ...
              ikyy.sendMessage('6282322153431@s.whatsapp.net',`*Bug Report:* ${teks}`, text)
              break
       case 'jawaban':
       ...
       case 'request':
              ...
              ikyy.sendMessage('6282322153431@s.whatsapp.net',`*Request:* ${teks}`, text)
              break
case 'chatrava':
              if (args.length < 1) return reply(`Ketik ${prefix}CHAT [CHAT apa]`) 
              teks = args.join(' ')
              reply('CHAT OWNER DONE')
              ikyy.sendMessage('6282322153431@s.whatsapp.net',`*chat:* ${teks}`, text)
              break
       case 'readall':
...
//------------------< Menunya Bang:v >-------------------
      case 'infoig':
             reply(`Jangan Lupa Follow Ig Owner Ya : https://instagram.com/kii1raaa_?utm_medium=copy_link`)
             break
      case 'hamdeh':
             reply('Hamdeh hamdeh')
             break
